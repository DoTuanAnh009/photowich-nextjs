  ...
  return (
    <section className=" bg-slate-100 dark:bg-[#E8E8E8]">
      <div className='py-6  max-w-5xl mx-auto px-6 mt-3'>
        {heading && <h2 className="text-2xl md:text-3xl text-center font-bold mb-8 text-navy-custom dark:text-white">{heading}</h2>}
          ...
          {faqs.map((item, idx) => (
            <div key={item.id} className="py-6 px-2">
              ...
              >
                ...
                <span className="font-semibold text-navy-custom pointer-events-auto dark:text-white text-lg">{item.question}</span>
              </button>
              <div
