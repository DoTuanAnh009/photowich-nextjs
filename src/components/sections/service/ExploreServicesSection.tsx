...
export function ExploreServicesSection({ heading, services }: ExploreServicesSectionProps) {
  ...
  return (
    <section className=" max-w-5xl mx-auto p-6">
      <h2 className="text-3xl font-bold text-center uppercase tracking-wider text-navy-custom dark:text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-3">
        {displayServices.map((service, idx) => (
          ...
          >
            <div className="relative w-full h-[250px] overflow-hidden flex items-center justify-center bg-slate-100 dark:bg-slate-700">
            ...
            <div className="p-6 flex flex-col gap-2 items-center flex-1 w-full text-center h-full">
              ...
              <Link
                ...
                className="mt-2 flex items-center justify-center px-6 py-2 rounded-full bg-yellow-400 text-navy-custom font-bold text-sm shadow hover:bg-yellow-500 transition-colors min-w-[140px] h-10"
                tabIndex={0}
